...
insert into Review(id,rating,description) values(40001,5,'very good tutorial');
insert into Review(id,rating,description) values(40002,4,'Great Exlpanation');
insert into Review(id,rating,description) values(40003,1,'Poor Quality! No discussion thread');
